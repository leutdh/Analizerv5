...
function ResultadosFacEvol({ resultados }) {
      ...
      <div className="w-full text-sm flex text-left text-gray-500 ">
        <div className="w-1/3">
          <h2
            ...
            data-tooltip-content="Este contenedor muestra los cargos enviados/cobrados de FACILITAR EVOL"
            data-tooltip-position-strategy="fixed"
          >
            ENVIOS DE CARGOS FACILITAR EVOL
          </h2>
        </div>
          ...
          <tbody>
            {resultadosFiltrados.length === 0 && (
              <tr>
                ...
                >
                  No se encontraron resultados para FACILITAR Evol.
                </td>
              </tr>
            )}
...
export default ResultadosFacEvol;
