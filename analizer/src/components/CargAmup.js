    ...
    >
      <div className="col-span-1">
        <h2
          ...
          data-tooltip-content="Este contenedor muestra informacion de los CARGOS ACTIVOS que tiene en AMUPROBA EVOL"
          data-tooltip-position-strategy="fixed"
        >
          CARGOS ACTIVOS EN AMUPROBA EVOL
        </h2>
      </div>
        ...
        <tbody>
          {resultados.length === 0 && (
            <tr>
              ...
              >
                No se encontraron Cargos en AMUPROBA.
              </td>
            </tr>
          )}
