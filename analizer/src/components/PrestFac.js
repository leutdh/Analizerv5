  ...
  >
    ...
    >
      ...
      >
        ...
        data-tooltip-content="Este contenedor muestra informacion de los prestamos que tiene o finalizo en FACILITAR EVOL"
        data-tooltip-position-strategy="fixed">
          ESTADO DE PRESTAMOS EN FACILITAR EVOL
        </h2>
      </div>
        ...
        <tbody>
          {resultados && resultados.length === 0 && (
            <tr>
              ...
              >
                No se encontraron Prestamos en FACILITAR.
              </td>
            </tr>
          )}
          {resultados &&
