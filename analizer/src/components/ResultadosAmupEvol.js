...
function ResultadosAmupEvol({ resultados }) {
      ...
      <div className="w-full text-sm flex text-left text-gray-500 ">
        <div className="w-1/3">
          <h2
            ...
            data-tooltip-content="Este contenedor muestra los cargos enviados/cobrados de AMUPROBA EVOL"
            data-tooltip-position-strategy="fixed"
          >
            ENVIOS DE CARGOS AMUPROBA EVOL
          </h2>
        </div>
          ...
          <tbody>
            {resultadosFiltrados.length === 0 && (
              <tr>
                ...
                >
                  No se encontraron resultados para AMUPROBA Evol.
                </td>
              </tr>
            )}
...
export default ResultadosAmupEvol;
