    ...
    >
      <div className="col-span-1">
        <h2
          ...
          data-tooltip-content="Este contenedor muestra informacion de los CARGOS ACTIVOS que tiene en ADM EVOL"
          data-tooltip-position-strategy="fixed"
        >
          CARGOS ACTIVOS EN ADM EVOL
        </h2>
      </div>
        ...
        <tbody>
          {resultados.length === 0 && (
            <tr>
              ...
              >
                No se encontraron Cargos en ADM.
              </td>
            </tr>
          )}
